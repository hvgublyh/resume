...
function Experience() {
  const experiences: TypeExperience[] = useSelector(
    (state: TypeStore) => state.userState.message.experiences,
  );
          ...
          {experience.project.map((project) => (
            <div className="project" key={project.name}>
              ...
              <p>
                ...
                <div className="detail">{project.tech.join("、")}</div>
              </p>
              <p>
